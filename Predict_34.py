...
class MultiTaskModel(nn.Module):
    def __init__(self, num_kinds, num_days):
        super().__init__()
        self.backbone = models.resnet34(pretrained=False)  # 预测时不用加载预训练权重
...
model.load_state_dict(torch.load(r"D:\Vscode\python_code\IGEM\best_model_resnet_34.pth", map_location=device))
model.to(device)
model.eval()
...
if __name__ == "__main__":
    test_img_path = r"C:\Users\16270\Documents\WeChat Files\wxid_g9jxbli2tq9u22\FileStorage\File\2025-06\lychee_dataset\images\rgb\sample_265_rgb.jpg"  # 替换成你想预测的图片路径
